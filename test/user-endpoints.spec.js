      ...
      it(`inserts 1 language with words for the new user`, () => {
        ...
        const expectedList = {
          ...
          words: [
            ...
            { original: '-.-.',  translation: 'C' },
            { original: '-..',  translation: 'D' },
            { original: '.',  translation: 'E' },
            { original: '..-.',  translation: 'F' },
            { original: '--.',  translation: 'G' },
            { original: '....',  translation: 'H' },
            { original: '..',  translation: 'I' },  
            { original: '.---',  translation: 'J' },
            { original: '-.-',  translation: 'K' },
            { original: '.-..',  translation: 'L' },
            { original: '--',  translation: 'M' },
            { original: '-.',  translation: 'N' },
            { original: '---',  translation: 'O' },
            { original: '.--.',  translation: 'P' },
            { original: '--.-',  translation: 'Q' },
            { original: '.-.',  translation: 'R' },
            { original: '...',  translation: 'S' },
            { original: '-',  translation: 'T' },
            { original: '..-.',  translation: 'U' },
            { original: '...-',  translation: 'V' },
            { original: '.--',  translation: 'W' },
            { original: '-..-',  translation: 'X' },
            { original: '-.--',  translation: 'Y' },
            { original: '--..',  translation: 'Z' },
            { original: '.----',  translation: '1' },
            { original: '..---',  translation: '2' },
            { original: '...--',  translation: '3' },
            { original: '....-',  translation: '4' },
            { original: '.....',  translation: '5' },
            { original: '-....',  translation: '6' },
            { original: '--...',  translation: '7' },
            { original: '---..',  translation: '8' },
            { original: '----.',  translation: '9' },
